/**
 * Module initializes rest service fitness2_delete_workout_plan_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_delete_workout_plan_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/12aa4ba9-b291-402c-a5bd-7dee546cf07d/exec",
            method: "post",
            headers: this.entityAPI.get("fitness2_delete_workout_plan_service.request.headers"),
            params: this.entityAPI.get("fitness2_delete_workout_plan_service.request.query"),
            data: this.entityAPI.get("fitness2_delete_workout_plan_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "fitness2_delete_workout_plan_service"
            }
        };
...
*/
export {
    fitness2_delete_workout_plan_service as ExportedClass
};