/**
 * Module initializes rest service fitness2_login_service
 */
import {
    Injectable
} from '@angular/core';
...
class fitness2_login_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/c967c4d4-caca-4f78-bca2-b81b0847d969/exec",
            method: "post",
            headers: this.entityAPI.get("fitness2_login_service.request.headers"),
            params: this.entityAPI.get("fitness2_login_service.request.query"),
            data: this.entityAPI.get("fitness2_login_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "fitness2_login_service"
            }
        };
...
*/
export {
    fitness2_login_service as ExportedClass
};