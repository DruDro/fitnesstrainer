/**
 * Module initializes rest service fitness2_family_users_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_family_users_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/ec2bb8f2-5238-40b0-bd04-88d9e4790065/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_family_users_service.request.headers"),
            params: this.entityAPI.get("fitness2_family_users_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_family_users_service"
            }
        };
...
*/
export {
    fitness2_family_users_service as ExportedClass
};