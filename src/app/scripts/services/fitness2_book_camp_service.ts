/**
 * Module initializes rest service fitness2_book_camp_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_book_camp_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/50ad198b-7b69-4016-973f-c2a955d56de9/exec",
            method: "post",
            headers: this.entityAPI.get("fitness2_book_camp_service.request.headers"),
            params: this.entityAPI.get("fitness2_book_camp_service.request.query"),
            data: this.entityAPI.get("fitness2_book_camp_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "fitness2_book_camp_service"
            }
        };
...
*/
export {
    fitness2_book_camp_service as ExportedClass
};