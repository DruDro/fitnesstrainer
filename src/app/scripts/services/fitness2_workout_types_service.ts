/**
 * Module initializes rest service fitness2_workout_types_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_workout_types_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/1872cc9c-276a-4a8e-8a24-418dd0aba8e7/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_workout_types_service.request.headers"),
            params: this.entityAPI.get("fitness2_workout_types_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_workout_types_service"
            }
        };
...
*/
export {
    fitness2_workout_types_service as ExportedClass
};