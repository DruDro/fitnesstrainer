/**
 * Module initializes rest service fitness2_trainer_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_trainer_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/79a132da-62c0-4bc8-8cb8-725a17ddc605/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_trainer_service.request.headers"),
            params: this.entityAPI.get("fitness2_trainer_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_trainer_service"
            }
        };
...
*/
export {
    fitness2_trainer_service as ExportedClass
};