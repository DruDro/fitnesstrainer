/**
 * Module initializes rest service fitness2_court_schedule_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_court_schedule_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/5c0c8b79-7e5c-422a-852a-24f74bb21135/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_court_schedule_service.request.headers"),
            params: this.entityAPI.get("fitness2_court_schedule_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_court_schedule_service"
            }
        };
...
*/
export {
    fitness2_court_schedule_service as ExportedClass
};