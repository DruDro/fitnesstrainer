/**
 * Module initializes rest service fitness2_courts_service
 */
import {
    Injectable
} from '@angular/core';
...
class fitness2_courts_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/690ca317-e723-42b3-bf40-b4ffd385a2e2/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_courts_service.request.headers"),
            params: this.entityAPI.get("fitness2_courts_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_courts_service"
            }
        };
...
*/
export {
    fitness2_courts_service as ExportedClass
};