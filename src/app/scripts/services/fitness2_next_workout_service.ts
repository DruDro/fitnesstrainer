/**
 * Module initializes rest service fitness2_next_workout_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_next_workout_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/08236d1f-f624-420b-9a6f-e62fc742b956/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_next_workout_service.request.headers"),
            params: this.entityAPI.get("fitness2_next_workout_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_next_workout_service"
            }
        };
...
*/
export {
    fitness2_next_workout_service as ExportedClass
};