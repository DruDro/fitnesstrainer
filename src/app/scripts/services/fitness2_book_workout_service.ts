/**
 * Module initializes rest service fitness2_book_workout_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_book_workout_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/e3f6d9af-2499-4ea5-b207-27a3fd7184a5/exec",
            method: "post",
            headers: this.entityAPI.get("fitness2_book_workout_service.request.headers"),
            params: this.entityAPI.get("fitness2_book_workout_service.request.query"),
            data: this.entityAPI.get("fitness2_book_workout_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "fitness2_book_workout_service"
            }
        };
...
*/
export {
    fitness2_book_workout_service as ExportedClass
};