/**
 * Module initializes rest service fitness2_users_service
 */
import {
    Injectable
} from '@angular/core';
...
class fitness2_users_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/a64ea320-bb59-4d4d-9f6c-5b8e4f27f97b/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_users_service.request.headers"),
            params: this.entityAPI.get("fitness2_users_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_users_service"
            }
        };
...
*/
export {
    fitness2_users_service as ExportedClass
};