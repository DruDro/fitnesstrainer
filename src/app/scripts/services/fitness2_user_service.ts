/**
 * Module initializes rest service fitness2_user_service
 */
import {
    Injectable
} from '@angular/core';
...
class fitness2_user_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/cdb491d9-d25f-4a8b-992f-cb0990647dc8/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_user_service.request.headers"),
            params: this.entityAPI.get("fitness2_user_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_user_service"
            }
        };
...
*/
export {
    fitness2_user_service as ExportedClass
};