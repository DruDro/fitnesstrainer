/**
 * Module initializes rest service fitness2_camps_service
 */
import {
    Injectable
} from '@angular/core';
...
class fitness2_camps_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/42f9820b-dbc0-4569-a076-9454a2cf6a17/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_camps_service.request.headers"),
            params: this.entityAPI.get("fitness2_camps_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_camps_service"
            }
        };
...
*/
export {
    fitness2_camps_service as ExportedClass
};