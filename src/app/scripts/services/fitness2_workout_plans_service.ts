/**
 * Module initializes rest service fitness2_workout_plans_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_workout_plans_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/e1593872-46d6-489f-863e-f51fbd95f6cf/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_workout_plans_service.request.headers"),
            params: this.entityAPI.get("fitness2_workout_plans_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_workout_plans_service"
            }
        };
...
*/
export {
    fitness2_workout_plans_service as ExportedClass
};