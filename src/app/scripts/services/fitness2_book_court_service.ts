/**
 * Module initializes rest service fitness2_book_court_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_book_court_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/2ee341a3-5a9b-450c-8087-db93cdf4fda2/exec",
            method: "post",
            headers: this.entityAPI.get("fitness2_book_court_service.request.headers"),
            params: this.entityAPI.get("fitness2_book_court_service.request.query"),
            data: this.entityAPI.get("fitness2_book_court_service.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "data",
                responseType: "json",
                serviceName: "fitness2_book_court_service"
            }
        };
...
*/
export {
    fitness2_book_court_service as ExportedClass
};