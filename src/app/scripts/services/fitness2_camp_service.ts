/**
 * Module initializes rest service fitness2_camp_service
 */
import {
    Injectable
} from '@angular/core';
...
class fitness2_camp_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/705d060e-9efc-48e7-8602-a187b824fd71/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_camp_service.request.headers"),
            params: this.entityAPI.get("fitness2_camp_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_camp_service"
            }
        };
...
*/
export {
    fitness2_camp_service as ExportedClass
};