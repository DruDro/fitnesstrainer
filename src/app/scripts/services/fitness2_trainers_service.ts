/**
 * Module initializes rest service fitness2_trainers_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_trainers_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/e00c62b4-bf14-4010-ad60-c8aab94ef247/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_trainers_service.request.headers"),
            params: this.entityAPI.get("fitness2_trainers_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_trainers_service"
            }
        };
...
*/
export {
    fitness2_trainers_service as ExportedClass
};