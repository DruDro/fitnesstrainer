/**
 * Module initializes rest service fitness2_family_workouts_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_family_workouts_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/4d4a8b00-01f2-407c-bbdd-ef016efa7133/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_family_workouts_service.request.headers"),
            params: this.entityAPI.get("fitness2_family_workouts_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_family_workouts_service"
            }
        };
...
*/
export {
    fitness2_family_workouts_service as ExportedClass
};