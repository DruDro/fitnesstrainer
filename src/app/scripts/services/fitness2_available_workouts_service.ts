/**
 * Module initializes rest service fitness2_available_workouts_service
 */
import {
    Injectable
} from '@angular/core';
...
@Injectable()
class fitness2_available_workouts_service {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/code/48590cf5-b9bc-4dd5-8e21-398a63cc2689/exec",
            method: "get",
            headers: this.entityAPI.get("fitness2_available_workouts_service.request.headers"),
            params: this.entityAPI.get("fitness2_available_workouts_service.request.query"),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "fitness2_available_workouts_service"
            }
        };
...
*/
export {
    fitness2_available_workouts_service as ExportedClass
};