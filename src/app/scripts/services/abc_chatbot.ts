/**
 * Module initializes rest service abc_chatbot
 */
import {
    Injectable
} from '@angular/core';
...
class abc_chatbot {
    ...
    execute(reqOpts ? : any) {
         ...
         */
        let config = {
            url: "https://api.appery.io/rest/1/ai/chatbots/conversation/321592f2-b596-4c9c-8eca-b18ec9ee753c",
            method: "post",
            headers: this.entityAPI.get("abc_chatbot.request.headers"),
            params: this.entityAPI.get("abc_chatbot.request.query"),
            data: this.entityAPI.get("abc_chatbot.request.body", undefined, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "abc_chatbot"
            }
        };
